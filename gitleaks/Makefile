...
PKG=github.com/ankitsaini2609/gitleaks
LDFLAGS=-ldflags "-X=github.com/ankitsaini2609/gitleaks/v7/version.Version=$(VERSION)"
_LDFLAGS="github.com/ankitsaini2609/gitleaks/v7/version.Version=$(VERSION)"
...
deploy:
	...
	docker build --build-arg ldflags=$(_LDFLAGS) -f Dockerfile -t ankitsaini2609/gitleaks:latest -t ankitsaini2609/gitleaks:$(VERSION) .
	echo "Pushing ankitsaini2609/gitleaks:$(VERSION) and ankitsaini2609/gitleaks:latest"
	docker push ankitsaini2609/gitleaks
